...
system = SystemInfo(
    ...
    failure_behavior=FailureBehavior(
        ...
        scenarios=[
            ...
            FailureScenarioConfig(scenario=_scenario("db_deadlock"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("connection_pool_exhausted"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("db_replication_lag"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("file_descriptor_exhausted"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("upstream_gateway_timeout"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("payment_gateway_failure"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("clock_skew_detected"), probability=0.03),
            FailureScenarioConfig(scenario=_scenario("pod_crashloop_backoff"), probability=0.03),
        ],
    ),
)
